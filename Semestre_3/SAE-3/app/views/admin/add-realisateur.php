...
<div class="add-form-container add-realisateur">
    <div class="add-form-header">
        <div class="emoji"><img src="<?= ImageHelper::url('img/logo/logo-cam.png') ?>" width="60" alt="logo-film" class="img-container"></div>
        <h1>Ajouter un réalisateur</h1>
    </div>

    <?php if ($success): ?>
        <div class="alert alert-success">
            ✅ Réalisateur ajouté avec succès ! Redirection...
        </div>
    <?php endif; ?>
    ...
    <form method="POST" action="/sae-3-festivote-tas-cesar/app/controllers/RealisateurController.php?action=add" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>Photo du réalisateur</label>
            <input type="file" name="photo" accept="image/*">
            <span class="form-info">Formats acceptés: JPG, PNG, GIF, WebP (max 5MB)</span>
        </div>

        <div class="form-actions">
            <button type="submit" class="btn-submit">➕ Ajouter le réalisateur</button>
            <a href="/sae-3-festivote-tas-cesar/app/views/pages/realisateurs.php" class="btn-cancel">❌ Annuler</a>
        </div>
    </form>
</div>
